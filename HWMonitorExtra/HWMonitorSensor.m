    ...
    if (value != NULL) {
        switch (group) {
            ...
            case VoltageSensorGroup:
            {
                ...
                return [[NSString alloc] initWithFormat:@"%1.2fV",v];
            } break;
...
- (NSString *)populateValue
{
    return [self formateValue:[HWMonitorSensor populateValueForKey:key]];
}

/*- (NSString *)readValue
{
    return [self formateValue:[HWMonitorSensor readValueForKey:key]];
}*/
