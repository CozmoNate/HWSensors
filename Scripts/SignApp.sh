...
codesign --verbose --force --sign "Developer ID Application" ./Binaries/HWMonitor.app/Contents/Frameworks/Sparkle.framework/Versions/A
codesign --verbose --force --sign "Developer ID Application" ./Binaries/HWMonitor.app/Contents/Frameworks/Growl.framework/Versions/A
codesign --verbose --force --sign "Developer ID Application" ./Binaries/HWMonitor.app
