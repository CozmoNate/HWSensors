...
{
	IOLog("--- %s GPU registers ---\n", nv_card->card_name);
	IOLog("NV_PMC_BOOT_0 (0x0): %08x\n", nv_card->PMC[0]);
	IOLog("NV_PBUS_DEBUG_0 (0x1080): %08x\n", nv_card->PMC[0x1080/4]);
	IOLog("NV_PBUS_DEBUG_1 (0x1084): %08x\n", nv_card->PMC[0x1084/4]);
	IOLog("NV_PBUS_DEBUG_2 (0x1088): %08x\n", nv_card->PMC[0x1088/4]);
	IOLog("NV_PBUS_DEBUG_3 (0x108c): %08x\n", nv_card->PMC[0x108c/4]);
	IOLog("NV_10F0 (0x10f0): %08x\n", nv_card->PMC[0x10f0/4]);
	IOLog("NV_1540 (0x1540): %08x\n", nv_card->PMC[0x1540/4]);
	IOLog("NV_15B0 (0x15b0): %08x\n", nv_card->PMC[0x15b0/4]);
	IOLog("NV_15B4 (0x15b4): %08x\n", nv_card->PMC[0x15b4/4]);
	IOLog("NV_15B8 (0x15b8): %08x\n", nv_card->PMC[0x15b8/4]);
	IOLog("NV_15F0 (0x15f0): %08x\n", nv_card->PMC[0x15f0/4]);
	IOLog("NV_15F4 (0x15f4): %08x\n", nv_card->PMC[0x15f4/4]);
	IOLog("NV_15F8 (0x15f8): %08x\n", nv_card->PMC[0x15f8/4]);
	IOLog("NV_PBUS_PCI_0 (0x1800): %08x\n", nv_read_pbus(PCI_VENDOR_ID));
	IOLog("NV_PBUS_PCI_0 (0x182c): %08x\n", nv_read_pbus(PCI_SUBSYSTEM_VENDOR_ID));

	if(nv_card->arch & (NV4X | NV5X))
	{
		IOLog("NV_C010 (0xc010): %08x\n", nv_card->PMC[0xc010/4]);
		IOLog("NV_C014 (0xc014): %08x\n", nv_card->PMC[0xc014/4]);
		IOLog("NV_C018 (0xc018): %08x\n", nv_card->PMC[0xc018/4]);
		IOLog("NV_C01C (0xc01c): %08x\n", nv_card->PMC[0xc01c/4]);
		IOLog("NV_C020 (0xc020): %08x\n", nv_card->PMC[0xc020/4]);
		IOLog("NV_C024 (0xc024): %08x\n", nv_card->PMC[0xc024/4]);
		IOLog("NV_C028 (0xc028): %08x\n", nv_card->PMC[0xc028/4]);
		IOLog("NV_C02C (0xc02c): %08x\n", nv_card->PMC[0xc02c/4]);
		IOLog("NV_C040 (0xc040): %08x\n", nv_card->PMC[0xc040/4]);
		IOLog("NV_4000 (0x4000): %08x\n", nv_card->PMC[0x4000/4]);
		IOLog("NV_4004 (0x4004): %08x\n", nv_card->PMC[0x4004/4]);
		IOLog("NV_4008 (0x4008): %08x\n", nv_card->PMC[0x4008/4]);
		IOLog("NV_400C (0x400c): %08x\n", nv_card->PMC[0x400c/4]);
		IOLog("NV_4010 (0x4010): %08x\n", nv_card->PMC[0x4010/4]);
		IOLog("NV_4014 (0x4014): %08x\n", nv_card->PMC[0x4014/4]);
		IOLog("NV_4018 (0x4018): %08x\n", nv_card->PMC[0x4018/4]);
		IOLog("NV_401C (0x401c): %08x\n", nv_card->PMC[0x401c/4]);
		IOLog("NV_4020 (0x4020): %08x\n", nv_card->PMC[0x4020/4]);
		IOLog("NV_4024 (0x4024): %08x\n", nv_card->PMC[0x4024/4]);
		IOLog("NV_4028 (0x4028): %08x\n", nv_card->PMC[0x4028/4]);
		IOLog("NV_402C (0x402c): %08x\n", nv_card->PMC[0x402c/4]);
		IOLog("NV_4030 (0x4030): %08x\n", nv_card->PMC[0x4030/4]);
		IOLog("NV_4034 (0x4034): %08x\n", nv_card->PMC[0x4034/4]);
		IOLog("NV_4038 (0x4038): %08x\n", nv_card->PMC[0x4038/4]);
		IOLog("NV_403C (0x403c): %08x\n", nv_card->PMC[0x403c/4]);
		IOLog("NV_4040 (0x4040): %08x\n", nv_card->PMC[0x4040/4]);
		IOLog("NV_4044 (0x4044): %08x\n", nv_card->PMC[0x4044/4]);
		IOLog("NV_4048 (0x4048): %08x\n", nv_card->PMC[0x4048/4]);
		IOLog("NV_404C (0x404c): %08x\n", nv_card->PMC[0x404c/4]);
		IOLog("NV_4050 (0x4050): %08x\n", nv_card->PMC[0x4050/4]);
		IOLog("NV_4054 (0x4054): %08x\n", nv_card->PMC[0x4054/4]);
		IOLog("NV_4058 (0x4058): %08x\n", nv_card->PMC[0x4058/4]);
		IOLog("NV_405C (0x405c): %08x\n", nv_card->PMC[0x405c/4]);
		IOLog("NV_4060 (0x4060): %08x\n", nv_card->PMC[0x4060/4]);
	}
	if(nv_card->arch & NV5X)
	{
		IOLog("NV_E100 (0xe100): %08x\n", nv_card->PMC[0xe100/4]);
		IOLog("NV_E114 (0xe114): %08x\n", nv_card->PMC[0xe114/4]);
		IOLog("NV_E118 (0xe118): %08x\n", nv_card->PMC[0xe118/4]);
		IOLog("NV_E11C (0xe11c): %08x\n", nv_card->PMC[0xe11c/4]);
		IOLog("NV_E120 (0xe120): %08x\n", nv_card->PMC[0xe120/4]);
		IOLog("NV_E300 (0xe300): %08x\n", nv_card->PMC[0xe300/4]);
		IOLog("NV_20008 (0x20008): %08x\n", nv_card->PMC[0x20008/4]);
		IOLog("NV_20400 (0x20400): %08x\n", nv_card->PMC[0x20400/4]);
		IOLog("NV_PDISPLAY_SOR0_REGS_BRIGHTNESS(%x): %08x\n", NV_PDISPLAY_SOR0_REGS_BRIGHTNESS, nv_card->PDISPLAY[NV_PDISPLAY_SOR0_REGS_BRIGHTNESS/4]);
	}

	IOLog("NV_PFB_CFG0 (0x100200): %08x\n", nv_card->PFB[0x200/4]);
	IOLog("NV_PFB_CFG0 (0x100204): %08x\n", nv_card->PFB[0x204/4]);
	IOLog("NV_PFB_CFG0 (0x100208): %08x\n", nv_card->PFB[0x208/4]);
	IOLog("NV_PFB_CFG0 (0x10020c): %08x\n", nv_card->PFB[0x20c/4]);
	IOLog("NV_PFB_218  (0x100218): %08x\n", nv_card->PFB[0x218/4]);
	IOLog("NV_PFB_TIMING0 (0x100220): %08x\n", nv_card->PFB[0x220/4]);
	IOLog("NV_PFB_TIMING1 (0x100224): %08x\n", nv_card->PFB[0x224/4]);
	IOLog("NV_PFB_TIMING2 (0x100228): %08x\n", nv_card->PFB[0x228/4]);
	IOLog("NV_PFB_474     (0x100474): %08x\n", nv_card->PFB[0x474/4]);
	IOLog("NV_PEXTDEV_BOOT_0 (0x101000): %08x\n", nv_card->PEXTDEV[0x0/4]);
	IOLog("NV_NVPLL_COEFF_A (0x680500): %08x\n", nv_card->PRAMDAC[0x500/4]);
	IOLog("NV_MPLL_COEFF_A (0x680504): %08x\n", nv_card->PRAMDAC[0x504/4]);
	IOLog("NV_VPLL_COEFF (0x680508): %08x\n", nv_card->PRAMDAC[0x508/4]);
	IOLog("NV_PLL_COEFF_SELECT (0x68050c): %08x\n", nv_card->PRAMDAC[0x50c/4]);
	IOLog("NV_NVPLL_COEFF_B (0x680570: %08x\n", nv_card->PRAMDAC[0x570/4]);
	IOLog("NV_MPLL_COEFF_B (0x680574: %08x\n", nv_card->PRAMDAC[0x574/4]);
