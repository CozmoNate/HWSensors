...
const SMCKeyInfo SmcKeyInfos[] =
{
    ...
    {"TCSc", "sp78", 2, "PECI SA", kSMCKeyGroupTemperature, 0, 0, 1},
    {"TCSA", "sp78", 2, "PECI SA", kSMCKeyGroupTemperature, 0, 0, 1}, // ??
    ...
    {"TM%XP", "sp78", 2, "Memory Module %X, Proximity", kSMCKeyGroupTemperature, 8, 1, 1}, // ?
    {"TM%XS", "sp78", 2, "Memory Module %X", kSMCKeyGroupTemperature, 8, 0, 1}, // ?
    {"TMA%X", "sp78", 2, "Memory Bank A, Slot %X", kSMCKeyGroupTemperature, 4, 1, 1}, // ?
    {"TMB%X", "sp78", 2, "Memory Bank B, Slot %X", kSMCKeyGroupTemperature, 4, 1, 1}, // ?
    ...
    //{"Tb%XP", "sp78", 2, "Battery %X Proximity", kSMCKeyGroupTemperature, 3, 0, 1},
    {"TB%XP", "sp78", 2, "Battery %X Proximity", kSMCKeyGroupTemperature, 3, 0, 1},
    ...
    {"Te%XS", "sp78", 2, "PCIe SLot %X", kSMCKeyGroupTemperature, 4, 1, 1}, // ?
    ...
    {"Vb0R", "sp1e", 2, "CMOS Battery", kSMCKeyGroupVoltage, 0, 0, 1}, // LPCSensors
    ...
    {"IC%XC", "sp78", 2, "CPU %X", kSMCKeyGroupCurrent, 4, 0xA, 0xA}, // ?
    {"IM%XS", "sp78", 2, "Memory Bank %X", kSMCKeyGroupCurrent, 4, 0xA, 0xA}, // ?
    {"IN0C", "sp78", 2, "PCH", kSMCKeyGroupCurrent, 0, 0, 1}, // ?
    {"IM0R", "sp5a", 2, "Memory Rail", kSMCKeyGroupCurrent, 0, 0, 1}, // ?
    ...
    {"IB0R", "sp4b", 2, "Battery Rail", kSMCKeyGroupCurrent, 0, 0, 1}, // ?
    {"IC0G", "sp69", 2, "GPU Core", kSMCKeyGroupCurrent, 0, 0, 1}, // ?
    {"Ie%XS", "sp78", 2, "PCIe Slot %X", kSMCKeyGroupCurrent, 8, 1, 1}, // ?
    {"Ie%XS", "sp78", 2, "PCIe Slot %X, Booster", kSMCKeyGroupCurrent, 8, 0xA, 1}, // ?
    {"IG%XC", "sp87", 2, "GPU %X", kSMCKeyGroupCurrent, 4, 0, 1}, // ?
    {"Ip0C", "sp78", 2, "Power Supply, +12V", kSMCKeyGroupCurrent, 0, 0, 1}, // ?
    ...
    {"PM%XS", "sp96", 2, "Memory Bank %X", kSMCKeyGroupPower, 3, 0xA, 0xA}, // ?
    {"PC0G", "sp96", 2, "GPU Core", kSMCKeyGroupPower, 0, 0, 1}, // ?
    {"PG0R", "sp96", 2, "GPU Rail", kSMCKeyGroupPower, 0, 0, 1}, // ?
    {"Pe%XS", "sp96", 2, "PCIe Slot %X", kSMCKeyGroupPower, 4, 1, 1}, // ?
    {"Pe%XS", "sp96", 2, "PCIe Slot %X, Booster", kSMCKeyGroupPower, 4, 0xA, 1}, // ?
    {"PG%XC", "sp96", 2, "GPU %X", kSMCKeyGroupPower, 4, 0, 1}, // ?
    {"PD0R", "sp96", 2, "Mainboard S0 Rail", kSMCKeyGroupPower, 0, 0, 1}, // ?
    {"PD5R", "sp96", 2, "Mainboard S5 Rail", kSMCKeyGroupPower, 0, 0, 1}, // ?
    {"Pp0C", "sp96", 2, "Power Supply, +12V", kSMCKeyGroupPower, 0, 0, 1}, // ?
