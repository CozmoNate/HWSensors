...
- (void)installWithToolAndRelaunch:(BOOL)relaunch
{
	...
	NSString *relaunchPathToCopy = [SPARKLE_BUNDLE pathForResource:@"Sparkle Updater" ofType:@"app"];
    ...
    NSString *relaunchToolPath = [relaunchPath stringByAppendingPathComponent: @"/Contents/MacOS/Sparkle Updater"];
