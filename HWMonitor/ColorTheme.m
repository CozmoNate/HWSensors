...
+ (NSArray*)createColorThemes
{
    ...
    theme.barPathColor = [NSColor colorWithCalibratedRed:0.3 green:0.3 blue:0.4 alpha:FILL_OPACITY];
    ...
    theme.barPathColor = [NSColor colorWithCalibratedRed:0.2 green:0.2 blue:0.3 alpha:FILL_OPACITY];
