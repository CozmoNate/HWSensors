...
-(void)insertColorThemes
{
    ...
    [self insertColorThemeWithName:@"Dark"
               ...
               listBackgroundColor:[NSColor colorWithCalibratedWhite:0.15 alpha:0.8]
                   listStrokeColor:nil//[NSColor colorWithCalibratedWhite:0.0 alpha:1.0]
                   toolbarEndColor:[NSColor colorWithCalibratedRed:0.03 green:0.23 blue:0.8 alpha:0.8]
                toolbarShadowColor:[[NSColor colorWithCalibratedRed:0.03 green:0.23 blue:0.8 alpha:0.8] highlightWithLevel:0.30]
                 toolbarStartColor:[[NSColor colorWithCalibratedRed:0.03 green:0.23 blue:0.8 alpha:0.8] highlightWithLevel:0.55]
